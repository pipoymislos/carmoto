...
SECRET_KEY = 'django-insecure-7kn9#=clz=0)xceg7w5!zqmd-y6n+&eu8vnupeyo1eu)q1g1-_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [ "carmoto.onrender.com",
    "localhost",
    "127.0.0.1"]
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # This will still look in app/templates/ folders
        'OPTIONS': {
            'context_processors': [
...
if DEBUG:
    # This allows serving media files in development
    import os
